  ...
  function movimiento(casilla) {
    ...
    if (casillas[0].innerHTML === casillas[1].innerHTML && casillas[0].innerHTML === casillas[2].innerHTML && casillas[0].innerHTML != '') {
      ...
      if (contador_casillas === 9) {
        banner_victoria.innerHTML = '<svg width="auto"height="100"><text x="0"y="70"style="font:bold 4.2em arial;fill:black;"viewBox="0 0 100 100">Empate<animate attributeType="XML"attributeName="x"from="-2030"to="1800"dur="5s"begin="0s"repeatCount="indefinite"/></text></svg>';
        breakEvent();
      }
    }
    jugador = !jugador
